...
Migrated from source command `opsx-archive` into a Codex skill. Invoke it as `$source-command-opsx-archive` and manually rewrite any slash-command behavior that depended on provider-specific runtime expansion.
