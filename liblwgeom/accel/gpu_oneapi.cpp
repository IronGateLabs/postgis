...
static sycl::queue *sycl_queue = nullptr;
static int oneapi_initialized = 0;
static char oneapi_device[256] = "unknown";
...
extern "C" int
lwgpu_oneapi_rotate_z_m_epoch(double *data, size_t stride, uint32_t n,
