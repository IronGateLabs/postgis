	...
	)
{
	...
	/*
	 * GDAL contour options (see GDALContourGenerateEx docs):
	 * LEVEL_INTERVAL, LEVEL_BASE, LEVEL_EXP_BASE, FIXED_LEVELS,
	 * NODATA, ID_FIELD, ELEV_FIELD, ELEV_FIELD_MIN, ELEV_FIELD_MAX,
	 * POLYGONIZE
	 */
